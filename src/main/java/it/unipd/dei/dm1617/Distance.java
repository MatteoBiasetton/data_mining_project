...
public class Distance implements Serializable {
    private static final int COSINE_DISTANCE = 0;
    private static final int EUCLEDIAN_DISTANCE = 1;
    ...
    public static double distance(Vector v1, Vector v2, int distanceType) {
        switch (distanceType) {
            ...
            default:
                System.out.println("Wrong distance id provided");
                return 0;
        }
    }
